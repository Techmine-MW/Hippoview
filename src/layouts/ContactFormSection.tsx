...
export default function ContactForm() {
    ...
    useEffect(() => {
        setValue('subject', `${userName} sent a message from Hippoview  Website`);
    }, [userName, setValue]);
            ...
            <div className='py-0 lg:py-0 px-4 mx-auto max-w-screen-md'>
                {!isSubmitSuccessful && (
                    <form onSubmit={handleSubmit(onSubmit)} className='space-y-8'>
                        <input
                            type='hidden'
                            value='be72bed1-1511-416c-b239-8d1fc253e4e7'
                            {...register('access_key')}
                        />
                        <input type='hidden' {...register('subject')} />
                        <input
                            type='hidden'
                            value='New Submission from Hippoview lodge Website'
                            {...register('from_name')}
                        />
                        <input
                            type='checkbox'
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            <div className="mb-6">
                                ...
                                >
                                    ...
                                    <option value="deluxe-single">Deluxe-Single Rooms</option>
                                    <option value="deluxe-Couple">Deluxe-Couple Rooms</option>
                                </select>
                                {errors.rooms && (
                                    <div className='mt-1 text-red-600'>
