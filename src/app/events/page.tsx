        ...
        <>
            ...
            <div className="bg-gradient-to-t from-sectionBackgroundColor to-white border-b border-border">
                ...
                <div className="container">
                    <p className="text-lg text-fontColor leading-10 my-10">Exclusive Offers, Exceptional Events - Elevate your experience with Hippoview Lodge. Indulge in our exclusive event spaces and discover unmatched offers. Immerse yourself in modern comfort paired with the unique charm of Africa. Make your gatherings extraordinary on the picturesque shores of Shire River.</p>
