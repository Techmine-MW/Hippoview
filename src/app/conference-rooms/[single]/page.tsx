...
const ConferenceSingle = ({ params }: { params: { single: string } }) => {
  ...
  const { title, meta_title, description, capacity, pictures, event_type } =
    frontmatter;
        ...
        <div className="border-b border-border pb-14 dark:border-darkmode-border">
          <div className="container lg:px-24">
            <div className="grid grid-cols-2 gap-1">
              ...
              <Link
                href="/contact"
                className="btn btn-primary btn-sm justify-self-end place-self-start"
              >
                Book Now
              </Link>
            </div>
          ...
          <div className="container mt-16 lg:flex justify-between items-center">
            <div className="lg:pr-4">
              <div className="flex justify-between border-b-2 p-3">
                <div>
                  <p className="text-lg text-fontColor">Capacity:</p>
                </div>
                <div>
                  <p className="text-lg text-fontColor">{capacity}</p>
                </div>
              ...
              <div className="flex justify-between border-b-2 p-3">
                <div>
                  <p className="text-lg text-fontColor">Event Type:</p>
                </div>
                <div>
                  <p className="text-lg text-fontColor">{event_type}</p>
                </div>
              </div>
          ...
          <div className="container text-center">
            <div className="my-12">
              <Link className="btn btn-secondary" href={"/conference-rooms"}>
