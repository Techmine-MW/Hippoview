...
const Home = () => {
  ...
  return (
    <>
      <div className="absolute inset-0 bg-cover bg-center banner-background"></div>
      <section className="pt-14 pb-6 relative">
        <div
          className="absolute inset-0 bg-cover bg-center"
          style={{ backgroundImage: `url('${banner.image3}')`, opacity: 0.7 }}
        ></div>
        <div className="container relative z-10">
          <div className="lg:flex justify-between">
            {/* Banner Content and Button on the Left */}
            <div className="mb-16 text-center lg:col-5 lg:order-1 text-white">
              <h1 className="mb-8 text-fontColor">
                Experience Luxury by the Shire River.{" "}
              ...
              <p
                className="text-lg mb-16 leading-10 text-fontColor font-bold"
              ...
              <div className="relative transform transition-all duration-300 hover:scale-105">
                ...
                {banner.button!.enable && (
                  <Link
                    ...
                    className="btn btn-primary btn-sm absolute bottom-8 left-1/2 transform -translate-x-1/2"
                  >
                    {banner.button!.label}
                  </Link>
                )}
      ...
      <section className="section-sm pb-0">
        <div className="container">
          <ScrollCardAnimation>
            <h2
              className="mb-16 text-center text-fontColor"
              dangerouslySetInnerHTML={markdownify(rooms.title)}
            />
      ...
      <div className="bg-gradient-to-t from-sectionBackgroundColor to-white border-b border-border">
        <div className="container mt-24">
          <ScrollCardAnimation>
            <h2 className="mb-16 text-center text-fontColor">
              Our Visual Showcase
            </h2>
            <HomePagePhotoGallery data={gallery} />
            <div className="flex justify-center items-center pb-14 pt-4">
              <Link className="btn btn-primary btn-md" href={"/contact"}>
                Save Your Spot
              </Link>
            </div>
          </ScrollCardAnimation>
