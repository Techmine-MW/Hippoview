          ...
          <ScrollCardAnimation>
            <div className="lg:grid grid-cols-2 gap-8">
              <div className="mx-auto mb-8 md:px-20 lg:px-0">
                ...
                <ul className="mt-6 ">
                  <li className="flex gap-2 items-center text-lg text-fontColor"><FaMapLocation className="text-accentColor" /> Address: Liwonde, Malawi</li>
                  <li className="flex gap-2 items-center text-lg text-fontColor mt-4"><FaPhone className="text-accentColor" /> Telephone: +265 999 256 624/ +265 999 351 249</li>
                  <li className="flex gap-2 items-center text-lg text-fontColor mt-4"><MdEmail className="text-accentColor" /> E-mail: gm@hippoviewlodge.com</li>
