        ...
        <>
            ...
            <section className="bg-backgroundColor border-b border-border">
                <div className="container mt-12">
                    <p className="text-lg text-fontColor leading-10 my-10">Modern Comfort with African Charm - Unwind in our River-facing rooms at Hippoview Lodge. Immerse yourself in the perfect blend of contemporary luxury and traditional African style for an unforgettable stay on the shores of Shire River.</p>
                    <div className="">
